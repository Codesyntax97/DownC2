...
/_______  /\____/ \/\_/|___|  /\______  /\_______ \                                                      """)))
        username = input(Colorate.Horizontal(Colors.DynamicMIX((Col.light_blue, Col.white)),"""Username ~➤ """))
        password = input(Colorate.Horizontal(Colors.DynamicMIX((Col.light_blue, Col.white)),"""Password ~➤ """))
...
""")))
    ...
    print(Colorate.Horizontal(Colors.DynamicMIX((Col.light_blue, Col.white)),("""              > Ｔｙｐｅ "ｈｅｌｐ" ｔｏ ｓｔａｒｔ <""")))
...
def main():
    ...
    while True:
        ...
        sin = input(Colorate.Horizontal(Colors.DynamicMIX((Col.light_blue, Col.cyan)),f"""{logged_in_user} ★ DownC2 ~➤ """))
        sinput = sin.split(" ")[0]
