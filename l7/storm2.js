...
const rateHeaders = [
  ...
  // Menambahkan header geo-location dengan koordinat Indonesia
  { "X-Geo-Location": '{"lat":-6.2088,"lon":106.8456}' }, // Jakarta, Indonesia
];
...
headers["x-requested-with"] = "XMLHttpRequest";
headers["X-BYPASS-GEO"] = "true";
headers["X-BYPASS-403"] = "true";
 const randomIP = getRandomIP();  // Fungsi untuk mendapatkan IP acak
...
// Fungsi untuk mendapatkan User-Agent acak (dari daftar umum atau generator)
