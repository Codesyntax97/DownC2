...
const RaptorMethod= Methods[Math.floor(Math.random() * Methods.length)];
...
console.log(`Methods: h2-strike`)
console.log(`Methods DDoS By Raptor`)
console.log(`--------------------------------------------`)
